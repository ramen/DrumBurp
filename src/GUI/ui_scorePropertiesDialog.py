...
class Ui_ScoreDialog(object):
    def setupUi(self, ScoreDialog):
        ...
        self.buttonBox.accepted.connect(ScoreDialog.accept)
        self.buttonBox.rejected.connect(ScoreDialog.reject)
        self.artistVisible.toggled.connect(self.artistEdit.setEnabled)
        self.creatorVisible.toggled.connect(self.creatorEdit.setEnabled)
        self.bpmVisible.toggled.connect(self.bpmSpinBox.setEnabled)
